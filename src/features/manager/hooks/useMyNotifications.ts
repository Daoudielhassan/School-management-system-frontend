...
import { MANAGER_NOTIFICATIONS_QUERY_KEY } from '../constants';
...
export function useMyUnreadNotificationCount() {
  ...
  return useQuery<number>({
    queryKey: [...MANAGER_NOTIFICATIONS_QUERY_KEY, 'unread-count'],
...
function useInvalidateMyNotifications() {
  ...
  return () => queryClient.invalidateQueries({ queryKey: MANAGER_NOTIFICATIONS_QUERY_KEY });
}
