/**
 * Class roster API layer — `GET /api/class-groups/{id}/students` plus
 * per-student detail lookups. Used to populate the attendance sheet and the
 * grade-entry student picker for a selected teaching assignment.
 */
